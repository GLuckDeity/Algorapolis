...
```
research/priority-gaps/
├── README.md                                          ← You are here
├── 01-information-sovereignty-priority-gap-research.md  ← Part I: Information Sovereignty (12 DPs)
├── 02-monetary-systems-priority-gap-research.md         ← Part II: Monetary Systems (12 DPs)
...
| Part | Title | Focus Area | Key Case Studies |
|------|-------|------------|------------------|
| **I** | [Information Sovereignty](file:///d:/GitHub/Algorapolis/research/priority-gaps/01-information-sovereignty-priority-gap-research.md) | 7-layer information stack, digital self-determination, cognitive security | Estonia, India (Aadhaar), EU GDPR, Ecuador (Rights of Nature), South Korea, USA PATRIOT Act |
| **II** | [Monetary Systems](file:///d:/GitHub/Algorapolis/research/priority-gaps/02-monetary-systems-priority-gap-research.md) | CBDC design, complementary currencies, Sovereign Wealth Funds, monetary discipline | China (e-CNY), Norway (GPFG), Wörgl (Austria), Japan (balance-sheet recession), Alaska, Mondragon |
| **III** | [Species Preservation](file:///d:/GitHub/Algorapolis/research/priority-gaps/03-species-preservation-priority-gap-research.md) | Rights of Nature, insect collapse, marine governance, conservation economics | Living Planet Index, Krefeld (Germany), Ecuador, Whanganui River (NZ), Svalbard Seed Vault, Y2Y, BBNJ |
...
*"A civilization operating under algorithmic governance must secure its information, balance its metabolic ledger, preserve its biospheric foundation, hold its security systems accountable, and prevent dynastic capital capture. These are not options; they are the boundary conditions of survival."*
